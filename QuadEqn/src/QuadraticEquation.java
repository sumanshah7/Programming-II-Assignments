...
public class QuadraticEquation {
    ...
    //Comparing a with 1, -1 and 0 and then comparing a>0 and a<0.
    //Comparing b with 1, -1 and 0 and then comparing b>0 and b<0
   //Comparing b with 0 and c>0 and c<0
    @Override
